How to Log In to Your Home Depot MyCard ?
=========================================

Manage Your Home Depot Credit Card Online — Quick & Easy
...
1. Open your browser and go to 👉 `homedepot.com/mycard <https://homedepot.com/mycard>`_  
2. Click **“Sign In”** — this will take you to the official Citi login page.  
3. Enter your **User ID** and **Password**.  
4. Click **“Sign On”** to access your account.  
5. ✅ Done! You can now view your balance, transactions, and payment options.
...
1. On the login page, click **“Register Your Card.”**  
2. Enter your **Card Number**, **Name**, and **Last 4 digits of SSN**.  
3. Create your **Username** and **Password.**  
4. Confirm your info — your card is now ready to manage online.


How to Pay Your Bill
--------------------

1. After signing in, click on **“Payments.”**  
2. Choose **“Make a Payment.”**  
3. Enter your **bank details** and **amount.**  
4. Click **“Submit”** — your payment is complete.


Forgot Password or User ID?
---------------------------

Click **“Forgot User ID or Password?”** on the login page and follow the instructions to reset it.


Safety Tips
-----------

- Always log in from the official link: `homedepot.com/mycard <https://homedepot.com/mycard>`_  
